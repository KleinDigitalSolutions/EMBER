...
const sceneOneParagraphs = [
  ...
  "Die Frau trug einen dunkelblauen Wollmantel, Kaschmirmischung, Gürtel hinten mit Schlaufe, der Schnitt vom letzten Winter bei Hoss, innen eine Stelle am Ärmel, an der Eva einmal Kaffee verschüttet hatte. Die Haare lagen in derselben Länge auf dem Mantelkragen. Die Schulter hatte den leichten Fall nach links, den Eva auf Fotos an sich selbst immer zuerst bemerkte, noch vor allem anderen.",
  "Eva hörte sich selbst ausatmen.",
  "Der Gedanke war da, bevor sie ihn abwehren konnte: *Das bin ich.*",
