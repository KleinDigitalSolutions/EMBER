const sceneOneParagraphs = [
  ...
  "Sie lachte kurz, einmal, ohne Ton. Ein App-Fehler. Irgendein Serverabgleich, der zwei Tage durcheinanderwarf. Gestern um 15:42 Uhr war sie nachweisbar in Frankfurt gewesen, das wusste sie so sicher wie ihren eigenen Namen. Mittwoch. Kundentermin, Konferenzraum, später Hotel. Kalender, BahnCard-Abrechnung, Mail-Thread mit Grau, alles sauber.",
  "Eva wischte den Bildschirm nach unten, ließ ihn neu laden. Der Eintrag blieb. Sie tippte auf die Zeile, bekam nur Zeitstempel, Haken und die knappe Systemnotiz, dass der Vorgang regulär erfasst worden sei.",
  "Sie rief nicht Simon an. Sie rief die Kita an.",
  "„Sonnengarten, Löwen.\"",
  "„Frau Löwen, Eva Berger. Es gibt einen Abgleichfehler in Ihrer App. Gestern steht bei mir ein Abholeintrag von mir um 15:42 Uhr. Das kann nicht stimmen. Ich war gestern um diese Uhrzeit in Frankfurt.\"",
  ...
  "„Bevor wir weiterreden, möchte ich Ihnen etwas zeigen\", sagte Petra.",
  "Eva spürte, wie sich etwas in ihrem Nacken zusammenschob. Ihre Hand lag neben dem Tablet, und sie hob sie nicht. „Die Kamera?\"",
  ...
  "Petra sagte hinter ihr etwas, einen Satz darüber, dass dies nur das Standbild vor dem Ablauf sei. Eva hörte die Worte als Geräusch.",
  "Eva legte die Fingerspitzen auf den Rand des Tisches, an dem der Monitor stand. Das Holz war kühl und real. Sie hielt sich an diesem Kühlen fest, während auf dem Bildschirm eine Frau, die sie war und nicht war, mit der Hand auf Milas Schulter stillstand."
];
