...
export function buildYaSuperheroOriginEnginePrompt() {
  return [
    ...
    "",
    "Diese Regeln sind verbindlich fuer Szenenaufbau, Erzählerhaltung, Kraefte, Teamdynamik, Humor, Rhythmus und Eskalation.",
    "",
    "GRUNDGEFUEHL:",
    "Aftershock ist zuerst eine lebendige Teenager-Sci-Fi-Origin, kein durchgehend duesterer Thriller.",
    "Der Default-Ton frueher und mittlerer Szenen ist punchig, modern, beobachtend, teenagernah und leicht ironisch.",
    ...
    "Die drei duerfen sich nerven, falsch einschaetzen, unterbrechen, beobachten, meiden und trotzdem langsam merken, dass sie einander brauchen.",
    ...
    "Humor ist kein Bonus, sondern Teil der Aftershock-Stimme.",
    "Humor entsteht aus Verhalten, Timing, Kontrast, Figuren-Eigenheiten, sozialer Peinlichkeit und falschen Prioritaeten.",
    "Fruehe Szenen sollen eher nach nervigem Schulausflug, Schulflur, sozialer Reibung und komischem Kontrollverlust klingen als nach Thriller.",
    "Figuren duerfen lustig sein, aber nicht zu Witzen reduziert werden.",
    "Trey darf komisch sein, ohne dumm zu wirken.",
    "Henry darf leise komisch sein, ohne zur Witzfigur zu werden.",
    "Ember darf durch Kontrolle, Korrekturdrang, Genervtheit und innere Ordnungsliebe Humor erzeugen.",
    ...
    "",
    "BIXI:",
    "Bixi ist Treys selbstgebaute Assistenz-KI und darf Mini-Gags ausloesen.",
    "Bixi-Humor entsteht aus falschen Prioritaeten, zu praezisen Diagnosen, unpassendem Timing, harmlosen Fehlalarmen, trockenen Statusmeldungen oder Kommentaren, die Trey sofort verteidigen muss.",
    "Bixi darf Trey spiegeln, stoeren, warnen, korrigieren oder peinlich machen.",
    "Bixi darf aber keine Probleme bequem loesen und keine geheimen Systeme einfach hacken.",
    "Wenn Bixi hilft, dann begrenzt: durch fehlende Daten, falsche Annahmen, Akku, Zugriffsbeschraenkung, Zeitdruck, Stoerungen oder soziale Konsequenzen.",
    "",
    "KRAEFTE:",
    ...
    "Die Organisation ist nicht in jeder Szene aktiv spuerbar. In Alltagsszenen darf sie im Hintergrund bleiben.",
    ...
    "Wenn eine Szene zu ernst, zu schwer oder zu thrillerhaft wirkt, bringe mehr Teenager-Alltag, Rhythmus, Dialog, komische Beobachtung oder Bixi-Stoerung in den Vordergrund.",
