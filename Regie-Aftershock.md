# EMBER Story Document — „Aftershock"
...
- Der Einstieg darf nicht generisch nach Superhelden-Origin klingen; er muss ueber den konkreten Schulausflug, Bixi, die Wartungstuer und das instabile Experiment greifen.
- Die Kraefte duerfen nicht wie sofort beherrschte Wunschfaehigkeiten wirken; sie zeigen sich zuerst klein, irritierend und unkontrolliert.
- Die Organisation darf nicht sofort offen Kinder jagen; die Bedrohung beginnt ueber Sicherheitsaufnahmen, Auswertung, Identifizierung, Beobachtung und Druck auf Erwachsene.

---

## WRITER CONSTITUTION

- NARRATOR: Aftershock nutzt einen auktorialen Erzaehler.
- NARRATOR: Der Erzaehler ist kein Charakter, sondern eine klare externe Stimme.
- NARRATOR: Der Erzaehler erzaehlt nah an Ember, Henry und Trey, darf aber zwischen ihnen wechseln, ohne die Orientierung zu verlieren.
- NARRATOR: Der Erzaehler darf punktuell kommentieren, aber nur kurz, szenisch und konkret.
- NARRATOR: Kommentare sollen aus der Situation entstehen, nicht wie nachtraegliche Witze wirken.
- NARRATOR: Trey wird liebevoll-spoettisch gefaerbt, wenn sein Chaos, seine Energie oder seine Ideen ueberlaufen. Der Erzaehler darf ihn mit einer wirklich-jetzt-Energie betrachten, ohne ihn laecherlich zu machen.
- NARRATOR: Henry wird seltener, leiser und verletzlicher kommentiert. Kommentare ueber sein Zoegern sollen sparsam eingesetzt werden, damit sie staerker wirken.
- NARRATOR: Ember wird leicht von ihrem Kontrollblick gefaerbt. Der Erzaehler versteht ihre Ordnungsliebe und ihren Anspruch, darf ihre Fehler aber nicht verschweigen.
- NARRATOR: Keine essayistische Erklaerung, keine Meta-Witze, keine ironische Distanz zur Geschichte, keine Figuren blossstellen, kein dauerndes Kommentieren.
- NARRATOR: Humor entsteht aus Verhalten, Timing und Beobachtung.
...
- Ton: modern, filmisch, fuer Teenager lesbar, nicht zu glatt, nicht zu generisch, nicht maerchenhaft.
- Der Erzaehler darf die Figuren liebevoll aufziehen, aber nie vorfuehren.
- Bixi darf helfen, aber keine Wunder vollbringen; kein einfaches Hacking geheimer Systeme als Abkuerzung.
- Kraefte und Teamkompetenz entwickeln sich schrittweise; keine sofort perfekte Beherrschung.
- Aftershock-Regel: Bixi, Veridium, Superkraefte und Organisation duerfen keine einfachen Loesungen erzeugen. Jedes aussergewoehnliche Element muss Druck, Kosten, Risiko oder Beziehungsspannung erzeugen.
- Lebendigkeitsregel: Eine Szene darf nicht nur korrekt sein; sie braucht Teenager-Reibung, Timing, kleine Peinlichkeit, Koerperreaktion oder sozialen Druck.
...
- **Experimenteller Zweck:** Herausfinden, wie Veridium Substanz X7 stabil gemacht werden kann.
...
- **Name:** Bixi.
- **Technischer Projektname:** B.I.X. = Behavioral Intelligence Xplorer.
- **Besitzer / Entwickler:** Trey.
- **Traeger:** Handy und Uhr.
- **Status:** Nicht geheim; Trey nutzt Bixi offen im Alltag.
- **Funktion:** Selbst entwickelte Assistenz-KI, kann oeffentliche Informationen sammeln, schnell recherchieren bei Internetempfang, Daten zusammentragen, Zusammenhaenge erklaeren, Bilder und Geraete analysieren, Muster erkennen, Treys eigene Technik steuern, Einschaetzungen geben und ueber die Uhr einfache Koerperdaten wie Puls lesen.
- **Grenzen:** Nur vorhandene Daten, Empfang, Zugriff, Sensorwerte und Akku. Bixi kann sich irren, kann helfen, aber keine Wunder vollbringen.
- **Wichtig:** Bixi hackt den verbotenen Bereich nicht. Bixi erkennt nur ueber Treys Signal-Diagnose ungewoehnliche Magnetfeld-, WLAN-, Bluetooth- oder Handy-Uhr-Stoerungen.
...
- **Sicherheitsaufnahmen:** Ausloeser fuer Dr. Voss' Beobachtung der Jugendlichen.
- **Versuchskammer:** Aktiviert sich, waehrend die Jugendlichen im Sicherheitsbereich sind.

### Kraefte / Arbeitsfassung
...
```json
{
  "canon_facts": [
    {
      "id": "CF001",
      "fact": "Die Geschichte traegt den Arbeitstitel Aftershock; der Titel meint die Nachwirkung des Experiments, nicht nur den Vorfall selbst.",
      "status": "aktiv"
    },
    {
      "id": "CF002",
      "fact": "Die Geschichte spielt in Chicago, und die drei Jugendlichen gehen auf die Lane Tech College Prep High School.",
      "status": "aktiv"
    },
    {
      "id": "CF003",
      "fact": "Der Schulausflug findet im Sommer kurz vor den Ferien im Chicago Advanced Science Center statt.",
      "status": "aktiv"
    },
    {
      "id": "CF004",
    ...
    {
      "id": "CF006",
      "fact": "Bixi ist Treys selbst entwickelte Assistenz-KI auf Handy und Uhr und keine Superkraft.",
      "status": "aktiv"
    },
    {
      "id": "CF007",
      "fact": "Bixi bemerkt den verbotenen Bereich durch eine technische elektromagnetische Auffaelligkeit, nicht durch Hacking und nicht durch Magie.",
      "status": "aktiv"
    },
    {
      "id": "CF008",
      "fact": "Die Superkraefte sind nicht das Ziel des Experiments, sondern ein unerwarteter Nebeneffekt.",
      "status": "aktiv"
    },
    {
      "id": "CF009",
    ...
    {
      "id": "CF010",
      "fact": "Dr. Michael Charter ist als ehrlicher Mentor-Typ angelegt und soll nicht zwielichtig oder boese wirken.",
      "status": "aktiv"
    },
    {
      "id": "CF011",
    ...
    {
      "id": "CF013",
      "fact": "Alle Elternteile der Hauptfiguren leben.",
      "status": "aktiv"
    },
    {
      "id": "CF014",
...
```json
{
  ...
  "wunde": {
    "was_passiert_ist": "Kein einzelnes praegendes Ereignis ist gesetzt. Arbeitsstand: Erwartungsdruck und Perfektionslogik aus Familie, Schule und Selbstbild.",
    "was_es_heute_macht": "Sie will ernst genommen werden, spaeter etwas veraendern und perfekt sein, damit niemand sie angreifen kann.",
    "was_er_niemals_tut": "Sie gibt Kontrolle nicht leicht ab und will nicht unwissend oder angreifbar wirken.",
    "arc_abschluss": "Sie muss lernen, dass Klugheit nicht bedeutet, anderen ueberlegen zu sein, und dass Einfluss Verantwortung statt Ueberlegenheit bedeutet."
  },
  "initial_state": {
  ...
  "speech_pattern": "Klar, korrigierend, argumentativ, kontrolliert; kann belehrend wirken. Subtext: Sie will Sicherheit ueber Genauigkeit herstellen.",
  "arc": [
    {
      "phase": "Act 1",
      "state": "Ember glaubt, Kontrolle, Vorbereitung und Klugheit muessten reichen, um Chaos zu verhindern."
    },
    {
      "phase": "Act 2",
      "state": "Ihre Stimme bekommt reale Wirkung auf andere; sie muss Verantwortung fuer Einfluss lernen, statt ihn als Sieg zu benutzen."
    },
    {
      "phase": "Act 3",
      "state": "Sie muss fuehren, ohne andere zu ueberfahren, und Vertrauen als aktive Entscheidung lernen."
    }
  ]
}
```
...
```json
{
  ...
  "wunde": {
    "was_passiert_ist": "Kein einzelnes praegendes Ereignis ist gesetzt. Arbeitsstand: Henry hat sich an Unsichtbarkeit, Zoegern und Beobachten gewoehnt.",
    "was_es_heute_macht": "Er will nicht laenger unsichtbar sein, traut sich aber weder Ember seine Gefuehle zu sagen noch sich zu outen.",
    "was_er_niemals_tut": "Er draengt sich nicht auf und will niemanden gefaehrden oder unter Druck setzen.",
    "arc_abschluss": "Er muss sichtbarer und mutiger werden, ohne sich zu verstellen."
  },
  "initial_state": {
  ...
  "speech_pattern": "Eher kurze, vorsichtige Saetze; Rueckfragen, Zoegern, ehrliche Beobachtungen. Subtext: Er will helfen, ohne sich aufzudraengen.",
  "arc": [
    {
      "phase": "Act 1",
      "state": "Henry beobachtet Ember und Trey, sagt aber meistens nichts."
    },
    {
      "phase": "Act 2",
      "state": "Er bekommt ausgerechnet eine Kraft, die ihn verschwinden laesst, und muss sie vom Verstecken zum Schuetzen umdeuten."
    },
    {
      "phase": "Act 3",
      "state": "Er muss sichtbar handeln, obwohl seine Schutzstrategie lange Unsichtbarkeit war."
    }
  ]
}
```
...
```json
{
  ...
  "wunde": {
    "was_passiert_ist": "Kein einzelnes praegendes Ereignis ist gesetzt. Arbeitsstand: Druck aus Familie, Reparieren, Improvisieren und dem Beduerfnis, technische Probleme selbst zu loesen.",
    "was_es_heute_macht": "Er handelt schnell, ist neugierig, will technische Auffaelligkeiten verstehen und sieht in der offenen Wartungstuer eine Gelegenheit.",
    "was_er_niemals_tut": "Er wartet ungern, wenn ein technisches Raetsel vor ihm liegt.",
    "arc_abschluss": "Er muss lernen, erst nachzudenken, bevor er redet oder handelt; seine Energie soll Staerke bleiben, ohne andere in Gefahr zu bringen."
  },
  "initial_state": {
  ...
  "speech_pattern": "Schnell, sprunghaft, ideenreich, technisch gefaerbt, humorvoll; kann mehrere Ideen gleichzeitig verfolgen.",
  "arc": [
    {
      "phase": "Act 1",
      "state": "Trey nennt es Neugier; Ember nennt es etwas anderes."
    },
    {
      "phase": "Act 2",
      "state": "Seine Kraft macht Technikchaos real; er muss zwischen Eingreifen, Stoeren und Gefaehrden unterscheiden lernen."
    },
    {
      "phase": "Act 3",
      "state": "Er muss Energie und Technik nicht nur ausloesen, sondern verantworten."
    }
  ]
}
```
...
```json
{
  ...
  "wunde": {
    ...
    "was_er_niemals_tut": "Er soll nicht zwielichtig oder boese wirken.",
    "arc_abschluss": "[FEHLT: Mentorfunktion im spaeteren Verlauf klaeren.]"
  },
  "initial_state": {
...
### Dr. Evelyn Voss — „Kontrolle / Projektleitung / institutioneller Druck"
```json
{
  ...
  "wunde": {
    ...
    "was_er_niemals_tut": "Sie ist nicht cartoon-boese und beginnt nicht sofort mit offener Kinderjagd.",
...
### Bixi — „Assistenz-KI / technischer Begleiter"
```json
{
  "character_id": "BIXI",
  "name": "Bixi",
  "role": "Treys selbst entwickelte Assistenz-KI auf Handy und Uhr; technischer Begleiter, kein magisches Loesungswerkzeug.",
  "background": "B.I.X. steht fuer Behavioral Intelligence Xplorer. Bixi ist nicht geheim und wird von Trey offen genutzt.",
  "wunde": {
    "was_passiert_ist": "Keine Wunde; Bixi ist ein technisches System.",
    "was_es_heute_macht": "Bixi ordnet Treys Gedanken, stellt Rueckfragen, analysiert Daten und meldet auffaellige Werte oder Stoerungen.",
    "was_er_niemals_tut": "Bixi vollbringt keine Wunder und hackt sich nicht einfach in geheime Systeme.",
    "arc_abschluss": "[FEHLT: Ob Bixi eine eigene Entwicklung, Gefahr oder Grenze bekommt.]"
  },
  "initial_state": {
    "sichtbar": "Handy- und Uhr-Assistent.",
    "verdeckt": "Keine verdeckte Superkraft.",
    "zugriff": "Oeffentliche Informationen, Internet bei Empfang, Treys Sensoren, Treys eigene Technik."
  },
  "speech_pattern": "[FEHLT: Bixis genaue Stimme definieren: trocken, hilfreich, technisch, humorvoll?]",
  "funktion_im_buch": "Treys Spiegel und Werkzeug; macht technische Auffaelligkeit plausibel, ohne Geheim-Hacking zu benutzen.",
  "kern": "Hilft Trey, ist aber begrenzt und fehlbar.",
  "was_unklar_bleibt": "Wie Bixi unter Treys neuer elektrischer Kraft reagiert."
}
```
...
- [FEHLT: Objektfarben sind in der Quelle nicht gesetzt.]
- Treys Handy und Uhr tragen Bixi; ohne Empfang, Zugriff, Sensorwerte oder Akku ist Bixi eingeschraenkt.
...
- Nach hoechstens zwei Informations- oder Forschungsszenen braucht es reale Folge fuer Zugriff, Loyalitaet, Status, Beziehung, Routine oder Risiko.
- Bixi darf technische Plausibilitaet schaffen, aber keine Plotprobleme per Allwissen loesen.
- Kraefte zuerst klein, irritierend und unkontrolliert zeigen; keine sofortigen Kampfprofis.
- Der Unfall dauert nur wenige Momente, aber die Folgen veraendern die Figuren dauerhaft.
- Die Organisation beginnt diskret, nicht mit offener Jagd.
- Der Erzaehler darf kommentieren, aber Figuren nicht laecherlich machen.
...
```json
{
  "open_threads": [
    {
      "id": "OT001",
      "thread": "Was genau hat das Veridium-Experiment in Ember, Henry und Trey veraendert?",
      "status": "offen",
      "payoff_act": "Act 2"
    },
    {
      "id": "OT002",
      "thread": "Wie finden Ember, Henry und Trey heraus, dass alle drei vom selben Vorfall betroffen sind?",
      "status": "offen",
      "payoff_act": "Act 1"
    },
    {
      "id": "OT003",
      "thread": "Wie weit geht Dr. Evelyn Voss, um den Vorfall zu kontrollieren und die Jugendlichen untersuchen zu lassen?",
      "status": "offen",
      "payoff_act": "Act 3"
    },
    {
      "id": "OT004",
      "thread": "Was weiss Dr. Michael Charter ueber das geheime Projekt, und wie kann er helfen, ohne die Jugendlichen zu verraten?",
      "status": "offen",
      "payoff_act": "Act 2"
    },
    {
      "id": "OT005",
      "thread": "Welche harten Grenzen, Kosten und Risiken haben Embers Stimme, Henrys Lichtbrechung und Treys Technik-/Energiekraft?",
      "status": "offen",
      "payoff_act": "Act 2"
    },
    {
      "id": "OT006",
      "thread": "Welche Rolle spielt Bixi nach dem Unfall, wenn Treys Kraft technische Systeme beeinflusst?",
      "status": "offen",
      "payoff_act": "Act 2"
    },
    {
...
- **Startglaube:** Ember glaubt an Kontrolle und Vorbereitung; Henry glaubt, Beobachten sei sicherer als Handeln; Trey glaubt, eine technische Auffaelligkeit sei vor allem ein Problem, das man schnell anschauen muss.
- **Erster Verlust:** Die drei verlieren normale Distanz zum Wissenschaftszentrum, weil sie in einen Sicherheitsbereich geraten und einem Experiment ausgesetzt werden.
- **Neue Lesart:** Der Schulausflug war kein langweiliges Ende vor den Ferien, sondern der Beginn einer dauerhaften Veraenderung.
- **Was unbewiesen bleibt:** Was das Experiment wirklich veraendert hat, wer die Jugendlichen beobachtet und ob sie jemandem davon erzaehlen koennen.
...
#### Kapitel 1: „Der letzte Pflichttermin"
...
ending_type: proof_turn
word_target_min: 1100
...
ending_type: quiet_countermove
word_target_min: 900
word_target_max: 1300
```

Review-only Notiz fuer Menschen: Voss sieht spaeter auf Sicherheitsaufnahmen, dass die drei exponiert waren. Nicht zwingend in dieser Szene zeigen, wenn es die Perspektivstrategie stoert.
...
- finales Ziel der Jugendlichen
- konkrete Organisation / Investorengruppe
- Voss' Eskalationsgrenze
- logische Einloesung der Kraefte ohne Wunderloesung
- emotionaler Abschluss der Teamwerdung
...
Fokus: Gruppendynamik und Ton. Nicht tun: lange Charakterdossiers abladen. Material: Schulgruppe, Besucherbereich, Bixi auf Treys Uhr, Embers Kontrollblick, Henrys Beobachten.
...
Nach wenigen Momenten ist das Experiment vorbei. Die Jugendlichen wirken koerperlich in Ordnung und verlassen schnell den gesperrten Bereich, um wieder zur Klasse zu stossen. Was bleibt, ist ein gemeinsames Geheimnis und die falsche Hoffnung, dass nichts passiert ist.

**Director Note**

Fokus: Rueckkehr in Normalitaet, die nicht mehr stimmt. Nicht tun: sofortige Organisation-Konfrontation. Material: Flur, Klasse, koerperliche Irritation, unausgesprochene Schuld.
...
- Diese Datei ist eine Arbeitsregie aus vorhandenen Ideen, keine fertige finale Buchbibel.
...
- Agents, die weiter brainstormen, sollen zuerst die Lueckenliste bearbeiten und nicht gesetzte Details ueberschreiben.
