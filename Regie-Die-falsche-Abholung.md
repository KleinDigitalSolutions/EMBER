...
| **Author Intent** | Dieses Buch soll human-led bleiben: EMBER darf Druck, Beweise und Kontinuität schärfen, aber nie die Geschichte in eine autonome Content-Fabrik verwandeln. Jede Szene muss Evas realen Alltagsverlust spürbar machen, nicht nur den Plot korrekt fortsetzen. |
| **Current Focus** | In den nächsten Szenen immer prüfen: Ist Mila als Kind sichtbar, bleibt Nora plausibel fehleranfällig, variiert der `ending_type`, und trägt ein konkretes Objekt oder eine soziale Folge die Spannung statt abstrakter Deutung? |
