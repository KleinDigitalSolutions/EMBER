# EMBER Story Document — „Ich sehe dich"
> Format: EMBER Book Blueprint v2 | Stand: 2026-04-23
> Autor: Oezguer Azap
...
| Feld | Inhalt |
|---|---|
| **Amazon Goal** | Standalone-Debuet mit hoher Kindle- und Paperback-Tauglichkeit, emotional sofort erklaerbarem Hook und starker Mund-zu-Mund-Empfehlung unter Muettern, Frauen 25-45 und Lesern, die ehrliche Alltagsintensitaet statt Plot-Gimmicks suchen. |
| **Category Lane** | Women's Fiction > Familienroman > Emotional Fiction |
| **Comp Titles** | Jojo Moyes fuer alltagsnahes Herz, Colleen Hoover nur als Intensitaetsgrenze ohne Effekthascherei, Liane Moriarty als Negativreferenz fuer kluge Mutterschaftsbeobachtung ohne deutsche Tonlage zu verlieren |
| **Commercial Hook** | Eine alleinerziehende Mutter, ein Kind, das mehr Halt braucht als andere, und ein Mann, der zum ersten Mal fragt: Wie geht es dir wirklich? Ein Roman ueber die Arbeit, die niemand sieht. |
| **Zielgruppe** | Frauen 25-45, besonders Muetter in belasteten Lebenslagen; auch Partner, Vaeter und Toechter, die verstehen wollen, wie sich unsichtbare Care-Arbeit anfuehlt |
| **Serienpotenzial** | Gering als direkte Fortsetzung, aber stark als Ton- und Themenmarke fuer weitere emotionale Alltagsromane ueber Frauen, die getragen haben, ohne gesehen zu werden |
| **Cover-Richtung** | Kein Kitsch, keine Silhouette vor Sonnenuntergang. Stattdessen ein konkretes Alltagsbild mit emotionalem Nachklang: Wichteltuer am Fussleistenrand, Kuechenlicht in der Nacht, gelber Schulranzen an einem Stuhl, kalter Kaffee neben Kinderstiften. |
...
- Keine Nebenfigur, die alles versteht und die Wahrheit in einem Satz liefert.
- Keine emotionalen Ueberkommentare nach starken Bildern.
- Keine Kitschmetaphern ueber Licht, Fluegel, Engel, Scherben, Ozeane im Herzen.
- Kein Ende, das Probleme loest statt Haltung sichtbar zu machen.

### Hook-Regel
- Kapitel 1 beginnt nachts auf dem Boden bei der Wichteltuer.
- Die erste Leitfrage lautet nicht: Was passiert als naechstes? Sondern: Wie lebt diese Frau, dass sie selbst in dieser Stille noch fuer jemand anderen arbeitet?
- Der erste Sog kommt aus Wiedererkennung, Liebe und Erschoepfung gleichzeitig.
...
- Pro Absatz nur ein starkes Bild. Danach weiter in Handlung oder Koerper.
- Innendeutung ist sparsam: maximal ein klarer Deutungssatz pro emotionalem Beat, danach wieder Objekt oder Handlung.
...
- Sein Einnässen ist kein Ereignis, sondern eine koerperliche Sprache fuer Ueberforderung.
- Weinen kommt bei ihm oft nicht aus einem grossen Anlass, sondern aus Reiz, Scham, Trennung, Muedigkeit.
...
- Cem lebt rund hundert Kilometer entfernt. Die Beziehung entsteht ueber konzentrierte Wochenenden, Fahrten, verpasste Zeitfenster und Kontakt dazwischen, der fuer beide nicht kostenlos ist.
...
- Gute Phasen von Tobias muessen so glaubhaft sein, dass sie Hoffnung ausloesen.
- Rueckfaelle kommen nicht als Twist, sondern als bittere Wiederholung.
- Henris Sehnsucht nach Tobias bleibt auch dann bestehen, wenn Tobias es nicht verdient hat.

### Jahreszeiten-Mechanik
- **Winter:** Enge, Dunkelheit, Ausdauer, stiller Trotz.
- **Fruehling:** erste Lockerung, erste Ehrlichkeit, neue Verwundbarkeit.
- **Sommer:** Luft, Zwischenraeume, die Zumutung eigener Beduerfnisse.
- **Herbst:** Rueckkehr der Angst vor Uebergang, dann Ankunft durch Einschulung.
...
```json
{
  "canon_facts": [
    ...
    {
      "id": "CF002",
      "fact": "Henri Mertens ist sechs Jahre alt, sensibel, braucht starke Rituale und hat bis kurz vor seinem sechsten Geburtstag regelmaessig eingenaesst.",
      "status": "aktiv"
    },
    {
      "id": "CF003",
      "fact": "Tobias Mertens, Henris Vater, ist Alkoholiker und pendelt zwischen trockenen Phasen und Entzugsklinik.",
      "status": "aktiv"
    },
    {
      "id": "CF004",
    ...
    {
      "id": "CF008",
      "fact": "Die Geschichte ist ueber vier Jahreszeiten gebaut und steuert auf Henris Einschulung zu.",
      "status": "Struktur-Anker"
    },
    {
      "id": "CF009",
...
```json
{
  ...
  "initial_state": {
    ...
    "psychisch": "wach, liebevoll, schamempfindlich, ausdauernd",
    "verhaeltnis_zur_arbeit": "Pflicht, Stolz und Selbstbeweis zugleich",
    "verhaeltnis_zu_henri": "tief verbunden, hochverantwortlich, manchmal ueberfordert von seiner Abhaengigkeit",
    "verhaeltnis_zu_sich_selbst": "nachrangig, unterversorgt, kaum noch als eigenes Zentrum erlebt"
  },
  "speech_pattern": "praezise, knapp, bei Erschoepfung haerter als beabsichtigt",
  "arc": [
    {
      "phase": "Act 1",
    ...
    {
      "phase": "Act 2",
      "state": "Sie beginnt auszusprechen, was sie sonst verschweigt, und merkt, wie ungewohnt sich Gesehenwerden anfuehlt."
    },
    {
      "phase": "Act 3",
...
### Henri Mertens — „Das Kind, das alles fuehlt"
```json
{
  "character_id": "HENRI",
  "name": "Henri Mertens",
  ...
  "wunde": {
    ...
    "was_er_niemals_tut": "Henri darf nie wie ein kleiner Therapeut oder Plotkommentator sprechen.",
    "arc_abschluss": "Henri wird nicht problemfrei, aber stabiler, weil sein Alltag und seine Mutter stabiler werden."
  },
  "initial_state": {
    "physisch": "schmal, blass, anschmiegsam, schnell ueberreizt",
    "psychisch": "wachsam, beduerftig, fantasievoll, empfindlich",
    "verhaeltnis_zu_laura": "absolutes Vertrauen bei maximaler Abhaengigkeit",
    "verhaeltnis_zu_tobias": "Sehnsucht und Leerstelle zugleich",
    "verhaeltnis_zu_routinen": "lebt ueber Wiederholung, Uebergangsobjekte und Vorhersehbarkeit"
  },
  "speech_pattern": "konkret, direkt, kindlich, oft ueber Dinge statt Gefuehle",
  "arc": [
    {
      "phase": "Act 1",
    ...
    {
      "phase": "Act 2",
      "state": "Er erlebt erste kleine Sicherheitsgewinne, bleibt aber fragil, besonders rund um Tobias."
    },
    {
      "phase": "Act 3",
    ...
    {
      "phase": "Act 4",
      "state": "Henri kann die Schultuer selbst durchgehen, ohne dass damit seine Sensibilitaet verschwindet."
    }
  ]
}
```
...
```json
{
  ...
  "arc": [
    ...
    {
      "phase": "Act 4",
      "state": "Er bleibt nicht, weil er gebraucht wird, sondern weil er sich bewusst dazustellt."
    }
  ]
}
```

### Tobias Mertens — „Die Abwesenheit"
```json
{
  "character_id": "TOBIAS",
  "name": "Tobias Mertens",
  ...
  "wunde": {
    ...
    "was_er_niemals_tut": "Tobias darf nie als sadistischer oder gleichgueltiger Boeswicht geschrieben werden.",
    "arc_abschluss": "Tobias bleibt kompliziert. Sein kleiner Satz im Sommer muss mehr Gewicht haben als jede grosse Entschuldigung."
  },
  "initial_state": {
    "physisch": "verbrauchter als frueher, phasenweise klar, phasenweise gezeichnet",
    "psychisch": "schamvoll, hoffend, rueckfallgefaehrdet, traurig",
    "verhaeltnis_zu_laura": "muede Distanz mit Restliebe und Schuld",
    "verhaeltnis_zu_henri": "sehnsuechtig, liebevoll, unzuverlaessig",
    "verhaeltnis_zu_sich_selbst": "zwischen Kampf und Selbstaufgabe"
  },
  "speech_pattern": "vorsichtig, stockend, manchmal fast zu klar in guten Phasen",
  "arc": [
    {
      "phase": "Act 1",
      "state": "Tobias taucht zunaechst nur ueber Anruf und Sehnsucht auf."
    },
    {
      "phase": "Act 2",
      "state": "Er wird fuer kurze Momente wieder konkret und macht gerade dadurch Verletzbarkeit groesser."
    },
    {
      "phase": "Act 3",
      "state": "Tobias schafft einzelne gute Begegnungen, bevor der naechste Rueckfall alles wieder unsicher macht."
    },
    {
      "phase": "Act 4",
...
```json
{
  ...
  "wunde": {
    ...
    "was_er_niemals_tut": "Sabine wird nicht zur Plottherapeutin oder zur Frau, die immer den perfekten Satz hat.",
    "arc_abschluss": "Sabine bleibt Nebenfigur, aber eine wichtige: Sie steht fuer nicht perfekte, echte Freundschaft."
  },
  "initial_state": {
    "physisch": "geordnet, warm, klar",
...
```json
{
  ...
  "wunde": {
    ...
    "was_er_niemals_tut": "Werner darf nie zum distanzierten, gleichgueltigen Vater werden.",
    "arc_abschluss": "Werner bleibt leise. Gerade deshalb muessen seine kleinen Gesten wie echte, unaufgeregte Liebe wirken."
  },
  "initial_state": {
    "physisch": "ruhig, gemütlich, oft mit Kaffeebecher im Bild oder in der Hand",
  ...
  "arc": [
    {
      "phase": "Act 1",
      "state": "Werner bleibt zunaechst am Rand, hoerbar im Hintergrund von Ingrids Telefonaten."
    },
    {
      "phase": "Act 2",
      "state": "Er hilft still ueber kleine Geldbetraege oder knappe Nachrichten ohne Kommentar."
    },
    {
      "phase": "Act 3",
...
```json
{
  ...
  "initial_state": {
    "physisch": "klein, wach, eigensinnig, oft warm zusammengerollt",
    "verhaeltnis_zu_laura": "vertraut, koerperlich selbstverstaendlich nah",
    "verhaeltnis_zu_henri": "geduldet, beobachtet, gelegentlich Ausloeser fuer Eifersucht",
    "verhaeltnis_zum_haushalt": "weiterer Pflegepunkt, aber emotional anders aufgeladen als alle anderen Aufgaben"
  }
}
```
...
- `Sie blieb sitzen, weil Henri auf ihrer Schulter endlich still war.`
- `Der Zettel war klein genug, um albern zu sein, und genau deshalb wichtig.`
...
- Er fragt oft mehrfach, weil Sicherheit fuer ihn Wiederholung ist.
- Seine Sprache darf ernst und kindlich zugleich sein.
- Wenn Henri belastet ist, wird er leiser, anhaenglicher oder ploetzlich weinend, nicht plotgerecht eloquent.
- Er benutzt Uebergaenge ueber Gegenstaende: Becher, Socken, Decke, Kuscheltier, Wichtel, Ranzen.
- Gute Henri-Saetze tragen Beduerfnis, Scham oder Freude im Konkreten.
- Schlechte Henri-Saetze klingen niedlich auf Effekt oder unnatuerlich weise.

Positive Muster:
- `Bleibst du noch, bis ich richtig schlafe?`
- `Papa kommt aber diesmal wirklich, oder?`
- `Ich will die Dinosocken. Die sind fuer Mut.`

Verbotene Drift:
- Keine erwachsene Gefuehlssprache.
...
- `Ich schaffe Schreiben heute nicht gut. Ich melde mich morgen richtig.`
- `Du musst mir nicht stark sein.`

Verbotene Drift:
- Kein Erloser-Sound.
- Keine ueberpointierten Maennerzeilen.
- Kein allwissender Trostspender.

### TOBIAS
- Tobias spricht mit Restschuld im Satz.
- In guten Phasen klingt er beinahe wie frueher, genau das muss weh tun.
- Er verspricht nicht laut, sondern hofft tastend.
- Gute Tobias-Saetze sind klein, klar und leicht zu spaet.
- Schlechte Tobias-Saetze klingen manipulativ oder melodramatisch boese.

Positive Muster:
- `Ich wollte nur hoeren, wie seine Stimme heute klingt.`
- `Ich weiss nicht, ob ich's diesmal halte, aber ich versuche es.`
- `Du hast gute Arbeit gemacht mit ihm.`

Verbotene Drift:
- Kein Suff-Monolog als Effekt.
- Keine billige Vaterbosheit.
...
Positive Muster:
- `Du darfst auch muede sein, ohne gleich undankbar zu wirken.`
- `Ich pass auf ihn auf. Du musst mir das nicht dreimal erklaeren.`
- `Vielleicht laesst du Dinge manchmal gehen, bevor sie dich verlassen koennen.`
...
### WERNER
- Werner spricht selten und kurz.
- Seine Liebe sitzt in Nebensaetzen, Ueberweisungen und Hintergrundsaetzen.
- Er fragt nicht tief nach, ist aber verlässlich da.
- Gute Werner-Zeilen sind klein und entlastend.
- Schlechte Werner-Zeilen machen ihn zum stummen Statisten ohne emotionale Funktion.

Positive Muster:
- `Gruess Henri von mir.`
- `Hab dir was ruebergeschickt.`
- `Der ist okay.`

Verbotene Drift:
- Kein plump weiser Vater.
- Keine spaete grosse Aussprache, die nicht zu ihm passt.
- Kein total passiver Schattenmann ohne eigene liebevolle Praxis.

### MIKROREGELN FUER DIALOG, INNENDEUTUNG UND ABSATZENDE
- Jede Dialogszene muss mindestens eines verschieben: Naehe, Schuld, Entlastung, Hoffnung oder Erwartung.
- Nach dem staerksten Gegenstandsmoment oder Koerperbild endet der Absatz. Kein Nachschlag.
- Wenn ein Satz bereits weh tut, folgt nicht noch einer, der erklaert, warum.
- Kapitelenden bevorzugen ein Objekt, eine kleine Geste oder einen Kindersatz statt eines grossen Fazits.
- Innenmonolog darf nie laenger sein als das konkrete, gegenstaendliche Material, an dem er sich festhaelt.
...
- Fruehling ist nicht ploetzlich leicht, sondern nur etwas durchlaessiger.
- Sommer muss Luft und Angst vor dieser Luft zugleich tragen.
- Herbst ist nicht nostalgisch, sondern angespannt, klar und verdient.

### Merksatz fuer EMBER
> Kanon in den `Codex`. Alltagsdruck in die `Scene Card`. Unsichtbare Arbeit immer ueber Objekt, Handlung und Koerper zeigen.
...
- Aus konkreten Situationen: Bahnhof, Kueche, Reparatur, Hotelmorgen, Handy-Schweigen, Abholmomente.
...
- Kein eloquenter Dauertherapeut.
...
## HENRI REGULATION MAP

Henri funktioniert nur dann glaubhaft, wenn sein Verhalten aus Bindung, Reiz und Koerper kommt und nicht als Symptomkatalog behandelt wird.

### Was Henri ausloest
- Uebergaenge ohne Vorwarnung.
- Ausfall oder Unsicherheit bei Tobias.
- Zeitdruck am Morgen.
...
- Sein Weinen wirkt fuer Aussenstehende "wegen nichts".
- Sein Schlaf, sein Bett oder sein Bauch werden zu Signalen.

### Was hilft
- Vorhersehbarkeit.
- Ein konkreter Gegenstand.
- Geduld ohne Erklaerungsdruck.
- Ein Erwachsener auf Bodenhoehe.
- Wiederholung ohne genervten Unterton.

### Was kippen laesst
- Zu viel Scham in der Situation.
- Erwachsene, die sein Verhalten nur korrigieren wollen.
- Tobias-Unsicherheit kurz vor Verabredungen.
- Ein neuer Schritt ohne alten Halt.

### Was Henri nicht ploetzlich koennen darf
- Keine lineare Heilung.
- Kein stundenlang erwachsenes Verarbeiten.
- Kein plotbequemer Gefuehlsumschwung nur fuer eine runde Szene.
- Kein Wunderkind bei der Einschulung.
...
```json
{
  "open_threads": [
    ...
    {
      "id": "OT002",
      "thread": "Kann Henri stabiler werden, ohne dass das Buch ihn kuenstlich heilt oder vereinfacht?",
      "status": "offen",
      "payoff_act": "Act 4"
    },
    {
      "id": "OT003",
      "thread": "Welche Rolle kann Tobias fuer Henri noch haben, wenn Liebe und Unzuverlaessigkeit gleichzeitig wahr sind?",
      "status": "offen",
      "payoff_act": "Act 4"
    },
    {
    ...
    {
      "id": "OT006",
      "thread": "Wie wird die Einschulung zu einem echten Ankunftsmoment statt zu einem blossen Kalendereintrag?",
      "status": "offen",
      "payoff_act": "Act 4"
    }
  ]
...
### ACT 1 — Winter — Ausdauer
> Eroeffnungs-Dokument: *Kleiner Zettel in Wichtelschrift neben einer winzigen Tuer an der Fussleiste.*
...
Scene Card
  ...
  alltagswaffe: Schlafmangel in einer stillen Wohnung
  soziale tarnung: Es sieht von aussen nach niedlicher Adventsidee aus
  falsche lesart: Das ist nur ein kleiner Mutter-Handgriff
  ersetzungsmoment: Funktionieren tritt an die Stelle von Ruhe
  closing_image: Die Wichteltuer im Flurlicht, waehrend im Spuelbecken noch Tassen stehen
  verbotene drift: Kein Weihnachtskitsch, keine ruehrige Kommentarstimme
  was die szene nicht tun darf: Die ganze Lebensgeschichte erklaeren statt im Detail zu zeigen
  setup: CF001, CF002, CF007, CF008, OT001
```
...
Scene Card
  ...
  ersetzungsmoment: Hoffen tritt kurz an die Stelle von Schutz
  closing_image: Das Kuechenhandtuch haengt schief ueber dem Spuelbecken
  verbotene drift: Kein Alkoholismus-Exkurs
  was die szene nicht tun darf: Tobias schon endgueltig verurteilen oder entlasten
...
Scene Card
  ...
  was die szene nicht tun darf: Sabine als perfekte Beobachterin schreiben
  setup: CF002, CF006, OT001, OT002
```
...
Scene Card
  ...
  ersetzungsmoment: Inszenierte Festlichkeit tritt an die Stelle von Familie
  closing_image: Baumlichter spiegeln sich im Weinrest im Glas
  verbotene drift: Kein kitschiger Feiertagsschmerz
  was die szene nicht tun darf: Tobias durch Abwesenheit zum Monster machen
  setup: CF003, CF004, OT003
```
...
Scene Card
  ...
  soziale tarnung: Es ist nur ein grauer Januar-Tag
  falsche lesart: Solche Tage zaehlen nicht erzählerisch
...
Scene Card
  ...
  soziale tarnung: Es ist nur ein Kaffee vor seiner Rueckfahrt
  falsche lesart: Das ist bloss ein nettes Treffen zwischendurch
...
Scene Card
  ...
  falsche lesart: Organisation bedeutet Stabilitaet
...
Scene Card
  ...
  ersetzungsmoment: Beobachten tritt an die Stelle von Teilhaben
  closing_image: Tobias' Hand auf Henris Kopf hinter dem Glas
  verbotene drift: Kein Rueckfall-Twist in der Szene
  was die szene nicht tun darf: Tobias sentimental verklären
  setup: CF003, CF004, OT003
```
...
Scene Card
  ...
  soziale tarnung: Es ist nur eine Reparatur an einem Samstag
  falsche lesart: Gemeinsame Wochenendzeit darf nicht praktisch werden
...
Scene Card
  ...
  was die szene nicht tun darf: Freiraum sofort romantisieren
  setup: CF006, OT001, OT005
```
...
Scene Card
  id: SC_2_7
  pov: LAURA
  ort: Kueche / Telefon / Kinderzimmer
  uhrzeit: frueher Abend
...
Scene Card
  ...
  alltagswaffe: Kinderblick
  soziale tarnung: Es ist nur ein Kita-Bastelgeschenk
  falsche lesart: Solche Geschenke sind reine Niedlichkeit
  ersetzungsmoment: Zuschreibung tritt an die Stelle von Selbstbild
  closing_image: Das krumme Bild am Kuehlschrank unter warmem Kuechenlicht
  verbotene drift: Kein Kitschtraenensog
  was die szene nicht tun darf: Henri als Stichwortgeber fuer die Botschaft benutzen
  setup: CF002, OT001, OT006
```
...
### ACT 3 — Sommer — Atem
> Eroeffnungs-Dokument: *Ein Ferientag ohne Reise, aber mit genug Zeit, um zum ersten Mal wieder an sich selbst zu denken.*
...
Scene Card
  ...
  falsche lesart: Ohne Urlaub kann kein Sommergefuehl entstehen
  ersetzungsmoment: Genug tritt an die Stelle von Mangelblick
  closing_image: Sonnenschutz, Dino-Handtuch und Sand auf den Dielen
  verbotene drift: Kein Sommerpostkarten-Ton
  was die szene nicht tun darf: Armutspathos daraus machen
  setup: CF001, CF002, OT001, OT002
```
...
Scene Card
  id: SC_3_4
  pov: LAURA
  ort: Wohnung / vor der Tuer / spaeter alleine
  uhrzeit: Wochenende
  ...
  was die szene nicht tun darf: Tobias schon in der Uebergabe sabotieren
...
Scene Card
  ...
  was die szene nicht tun darf: Das Wochenende als problemloses Glueck verkaufen
  setup: CF005, CF009, OT001, OT004, OT005
```
...
Scene Card
  ...
  soziale tarnung: Es ist nur eine Rueckgabe nach dem Wochenende
  falsche lesart: Tobias' Anerkennung muesste alles leichter machen
  ersetzungsmoment: Gesehenwerden tritt kurz an die Stelle von alter Wut
  closing_image: Henri zieht im Flur seine Schuhe aus, waehrend Tobias draussen schon wieder weg ist
  verbotene drift: Kein grosse Versoehnung
  was die szene nicht tun darf: Tobias zu schnell erlösen
  setup: CF003, CF004, OT003
```
...
Scene Card
  ...
  soziale tarnung: Es ist nur ein kurzes Nachgespraech nach zu langer Stille
  falsche lesart: Nur der Verlassene hat Angst
  ersetzungsmoment: Gegenseitigkeit tritt an die Stelle von Abwehr
  closing_image: Zwei Menschen stehen im Kuechenlicht zwischen Wasserkocher und Kindermalstiften
  verbotene drift: Kein filmreifer Versoehnungskusszwang
  was die szene nicht tun darf: Den Konflikt rueckwirkend kleinreden
  setup: CF005, OT004, OT005
```
...
### ACT 4 — Herbst — Ankunft
> Eroeffnungs-Dokument: *Ein Dinosaurier-Schulranzen im Laden, auf den Henri ohne Zoegern zeigt.*
...
Scene Card
  ...
  falsche lesart: Einschulung beginnt erst am eigentlichen Schultag
  ersetzungsmoment: Zukunft tritt an die Stelle von Rueckblick
  closing_image: Henri legt seine Hand auf den Dino-Ranzen, als haette er ihn schon immer gekannt
  verbotene drift: Kein Schulstart-Katalogton
  was die szene nicht tun darf: Den Moment nur nostalgisch rahmen
  setup: CF002, CF008, CF010, OT002, OT006
```
...
Scene Card
  ...
  falsche lesart: Traenen waeren schlimmer als Fassung
  ersetzungsmoment: Stille tritt an die Stelle von Protest
  closing_image: Henris `Okay` bleibt im Kinderzimmer haengen
  verbotene drift: Kein finales Tobias-Drama
  was die szene nicht tun darf: Tobias zur letzten Pruefung boesartig zuspitzen
...
Scene Card
  ...
  ending: Als Henri ruft, dreht sie sich um und ist bereit.
  beweisobjekt: Die fuer den Tag herausgelegten Dino-Socken
  alltagswaffe: Morgenstille
  soziale tarnung: Es ist nur die erste halbe Stunde des Tages
  falsche lesart: Erkenntnis muss als grosses Lebensfazit kommen
  ersetzungsmoment: Gewissheit tritt an die Stelle von Selbstanklage
  closing_image: Kaffee dampft neben den ordentlich hingelegten Dino-Socken
  verbotene drift: Kein triumphierender Befreiungston
  was die szene nicht tun darf: Die Schlussbotschaft zu frueh aussprechen
  setup: CF007, CF010, OT001, OT006
```
...
Scene Card
  ...
  soziale tarnung: Es ist nur hektische Morgenroutine
  falsche lesart: Die Einschulung beginnt erst an der Schule
...
Scene Card
  ...
  ersetzungsmoment: Vertrauen tritt an die Stelle von Festhalten
  closing_image: Zwei Dinosaurier-Ranzen nebeneinander in Bewegung
  verbotene drift: Kein Zeitlupenkitsch
  was die szene nicht tun darf: Henri uebererklaeren oder extra ruehrend machen
...
Scene Card
  ...
  falsche lesart: Grosse Gefuehle brauchen viele Worte
  ersetzungsmoment: Verdichtung tritt an die Stelle von Erklaeren
  closing_image: Der gesendete Satz auf dem Handydisplay
  verbotene drift: Kein Whatsapp-Kitsch
  was die szene nicht tun darf: Die Szene ueber Sabines Reaktion definieren
  setup: CF006, OT006
```
...
Scene Card
  ...
  ort: Kueche
  uhrzeit: Nachmittag
  ziel: Den ersten Schultag ueber Henris Rueckkehr in Sprache und Tempo nachhallen lassen.
  ...
  soziale tarnung: Es ist nur ein erster Nachmittag nach der Schule
  falsche lesart: Die grosse Emotion endet an der Schultuer
  ersetzungsmoment: Alltag tritt an die Stelle von Ausnahmezustand
  closing_image: Henri redet mit vollem Mund ueber Luca und den gleichen Ranzen
  verbotene drift: Kein reines Epilog-Kapitel
  was die szene nicht tun darf: Henri zu glatt oder erwachsen klingen lassen
  setup: CF002, CF010, OT002, OT006
```
...
Diese Sektion ist fuer den operativen Ember-Writer gedacht. Die Scene Cards bleiben der haerteste Regieanker. Die folgenden Summaries verdichten alle 40 Kapitel so, dass Drafting nicht in Kitsch, Erklaerung oder generische Emotionalitaet driftet.
...
### Kapitel 35 — „Erster Schultag"
**Writer Summary**
Der Morgen der Einschulung ist Handgriff, Foto, Frage, Brotdose, Ranzen. Cem ist da, weil er bewusst fuer diesen Tag geblieben ist, ohne im Zentrum zu stehen. Der Moment muss nach Familie im Werden klingen, nicht nach fertiger Heilung.
...
### Kapitel 36 — „Die Schultuer"
**Writer Summary**
Das Loslassen passiert ueber einen anderen Jungen mit demselben Ranzen. Kein grosses Kindergespräch. Nur Bewegung, Vergleich und eine ploetzlich leere Hand. Das Kapitel ist der emotionale Kern des Finales.
...
- Nicht `wie Colleen Hoover`, sondern ehrlicher, deutscher, alltaeglicher.
- Kein Moment darf konstruiert klingen.
- Die Leserin soll mindestens einmal pro Kapitel denken: Genau so ist das.
- Das Finale lebt davon, dass es klein bleibt.
