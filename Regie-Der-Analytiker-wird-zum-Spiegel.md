...
| Feld | Inhalt |
|---|---|
| **Prämisse** | Ein externer forensischer Gutachter muss eine Legalprognose für Deutschlands bekanntesten Serienmörder schreiben: Darf der Mann nach 18 Jahren Unterbringung erstmals unbegleitete Lockerungen erhalten? Mit jeder Sitzung wird klarer, dass der Täter nicht um Freiheit kämpft, sondern um Deutungshoheit. Und dass das Gutachten am Ende mehr über den Gutachter verraten könnte als über den Mörder. |
...
| Feld | Inhalt |
|---|---|
| **Amazon Goal** | Standalone-Debüt mit starker Kindle-/Paperback-Tauglichkeit |
| **Category Lane** | Psychological Thriller > Crime Thriller > Literary Suspense |
| **Comp Titles** | Alex Michaelides „The Silent Patient" (Therapeut-Patient-Dynamik), Danya Kukafka „Notes on an Execution" (Entglamourisierung des Killers), Thomas Harris „The Silence of the Lambs" (psychologisches Machtduell), Ottessa Moshfegh „Eileen" (psychische Verdichtung, aber als Negativbeispiel für zu langes statisches Warten auf Plot) |
| **Commercial Hook** | Nicht: „Kann man einem Mörder trauen?" Sondern: „Was, wenn ein Gutachten nur deshalb plausibel klingt, weil der Gutachter heimlich über sich selbst schreibt?" |
| **Serienpotenzial** | Niedrig bis mittel. Dieses Buch muss vollständig als Einzelband funktionieren. Eine lose Rückkehr des Gutachters wäre erst nach einem starken Band 1 sinnvoll. |
| **Cover-Richtung** | Kühle institutionelle Ästhetik: Glas, Neon, Aktenrand, Reflexion einer sitzenden Figur in Sicherheitsglas. Keine blutigen Motive. Keine Waffe. Kein Gesicht frontal. |

### Marktentscheidung fuer das Debüt
- Nicht auf einen einzigen Twist bauen.
...
### Stilregeln (Positiv)
- Nahe, kontrollierte dritte Person auf den Gutachter. Kein allwissender Erzähler.
- Kurze bis mittlere Kapitel: 900–1.700 Wörter.
- Sitzungskapitel tragen klare Köpfe im Protokollstil: `[SITZUNG 2 — 10:05 Uhr]`
- Außenszenen haben keinen klinischen Kopf und wirken dadurch freier, aber nie gemütlich.
- Prosa bleibt präzise, trocken, beobachtend. Keine psychologische Schwafelei.
- Dialoge arbeiten mit Lücken, Ausweichungen, Gegenfragen und Schweigen.
- Jede Sitzung muss einen fachlichen Zweck haben und zugleich die Machtbalance verschieben.
...
- Kein Täter-POV.
- Kein „Hannibal-Lecter-Zaubertrick", bei dem der Mörder unrealistisch allwissend ist.
- Keine Szene, in der der Täter plötzlich körperlich ausrastet und damit den psychologischen Stoff ersetzt.
...
### Hook-Regel
- Kapitel 1 beginnt nicht mit dem Täter, sondern mit der Unterschrift unter den Auftrag.
- Die erste Frage des Buches lautet nicht: „Hat er es getan?", sondern: „Kann dieser Mann riskieren, sich noch einmal zu irren?"

### Ende-Regel
- Das Finale beantwortet die Verfahrensfrage, nicht die metaphysische Frage.
- Unklar bleiben darf, ob Cord wirklich rehabilitationsfähig wäre.
- Klar werden muss, dass Fehrs Objektivität beschädigt ist.
- Der letzte Satz des Buches ist ein Bild oder eine Handlung, keine These.
...
### Setting
- **Ort:** Deutschland, Gegenwart. Fiktive Großstadt „Rheinstadt".
- **Hauptschauplatz:** Forensische Klinik Hohenhort, Hochsicherheitsabteilung für schwere Gewalt- und Sexualdelikte.
- **Sekundäre Räume:** Fehrs Wohnung, Kanzlei/Institut, Gerichtsflure, Archiv, Parkhaus, Café am Klinikrande.
- **Atmosphäre:** Glas, Neon, Papier, Winterlicht. Keine Gothic-Finsternis, sondern klinische Kälte.

### Forensischer Realismus-Anker
- Es geht nicht um eine naive „Resozialisierbar: ja/nein?"-Frage.
- Es geht um ein externes Prognosegutachten vor einer konkreten Lockerungsentscheidung.
- Cord ist seit Jahren institutionell stabil, sprachlich kontrolliert und aus Sicht der Klinik ein Vorzeige-Patient.
- Genau das macht ihn gefährlich: nicht als Monster in Ketten, sondern als Mensch, der jede professionelle Kategorie souverän bedient.

### Die Klinik — Hohenhort
- Besuchsraum mit Sicherheitsglas nur für Sonderfälle; Cord sitzt Fehr in einem normalen forensischen Gesprächsraum gegenüber.
- Jede Sitzung wird protokolliert; Tonaufzeichnung ist möglich, aber nicht jede Passage ist transkribiert.
- Die Klinikleitung will ein sauberes, belastbares Gutachten — aber nicht zwingend ein negatives.
- Es gibt institutionelle Eigeninteressen: gute Behandlungserfolge, mediale Ruhe, juristische Absicherung.

### Die Verfahrenslage
- Cord soll nicht „freigelassen" werden.
- Im Raum steht die erste unbegleitete externe Lockerung als Vorstufe späterer Resozialisierung.
- Fehrs Votum ist nicht allein entscheidend, aber es hat hohes Gewicht.
- Wenn er negativ votiert, muss er es fachlich tragen.
- Wenn er positiv votiert und etwas passiert, ist seine Karriere beendet.
...
```json
{
  "canon_facts": [
    {
      "id": "CF001",
      "fact": "Dr. Hannes Fehr, 46, ist forensischer Psychologe und als externer Sachverständiger auf Gefährlichkeits- und Legalprognosen spezialisiert.",
      "status": "aktiv"
    },
    {
      "id": "CF002",
      "fact": "Elias Cord, 58, wurde wegen einer Serie von fünf Morden an Frauen verurteilt und gilt als einer der bekanntesten Gewaltstraftäter des Landes.",
      "status": "aktiv"
    },
    {
      "id": "CF003",
      "fact": "Cord sitzt nicht mehr im Regelvollzug, sondern seit Jahren im forensischen Behandlungssystem und hat dort eine nahezu makellose Akte.",
      "status": "aktiv"
    },
    {
      "id": "CF004",
      "fact": "Fehr hat vor Jahren in einem anderen Fall eine zu optimistische Prognose mitgetragen. Der entlassene Mann wurde später erneut gewalttätig.",
      "status": "aktiv — Wunde"
    },
    {
      "id": "CF005",
      "fact": "Fehr nimmt den Cord-Auftrag offiziell aus fachlichem Pflichtgefühl an, tatsächlich aber auch, um die alte Fehlprognose innerlich zu überschreiben.",
      "status": "subtext"
    },
    {
      "id": "CF006",
      "fact": "Die Klinikleitung drängt auf Ruhe und saubere Abläufe, weil der Fall mediale Aufmerksamkeit erzeugt und politisch beobachtet wird.",
      "status": "aktiv"
    },
    {
      "id": "CF007",
      "fact": "Cord hat nie die Taten widerrufen, aber seit Jahren eine kontrollierte Sprache des Bedauerns und der Verantwortung entwickelt.",
      "status": "aktiv"
    },
    {
      "id": "CF008",
      "fact": "Fehrs Privatleben ist funktional, aber ausgedünnt: getrennt lebend, lose Beziehung zur Tochter, kein inneres Auffangnetz.",
      "status": "aktiv"
    },
    {
      "id": "CF009",
      "fact": "Das Verfahren kulminiert in einer Anhörung in elf Tagen.",
...
### Dr. Hannes Fehr — „Der Gutachter"
```json
{
  "character_id": "FEHR",
  "name": "Dr. Hannes Fehr",
  "role": "Externer forensischer Gutachter",
  "background": "Forensischer Psychologe mit Reputation fuer kuehle, belastbare Prognosen. Frueher kliniknah, heute freier Sachverstaendiger.",
  "wunde": {
    "was_passiert_ist": "Vor neun Jahren hat Fehr in einem Grenzfall eine zu positive Risikoeinschaetzung abgegeben. Der Mann wurde spaeter erneut gewalttaetig; das zweite Opfer starb nicht, blieb aber dauerhaft gezeichnet.",
    "was_es_heute_macht": "Fehr verwechselt seitdem Vorsicht mit Redlichkeit. Er glaubt, er sei strenger geworden. Tatsachlich ist er nur weniger frei.",
    "was_er_niemals_tut": "Leichtfertig Hoffnung attestieren.",
    "arc_abschluss": "Fehr erkennt nicht ploetzlich die Wahrheit, sondern merkt zu spaet, dass sein Gutachten teilweise ein Selbstschutzdokument ist."
  },
  "initial_state": {
  ...
  "arc": [
    {"phase": "Act 1", "state": "Will neutral bleiben und merkt nicht, wie sehr er den Auftrag braucht."},
    {"phase": "Act 2", "state": "Cord bringt ihn dazu, biografisch zu lesen statt forensisch zu pruefen."},
    {"phase": "Act 3", "state": "Er schreibt ein fachlich plausibles, innerlich kontaminiertes Gutachten."}
  ]
}
```

### Elias Cord — „Der Patient, der keiner sein will"
```json
{
  "character_id": "CORD",
  "name": "Elias Cord",
  "role": "Untergebrachter Serienmoerder",
  "background": "Verurteilt fuer fuenf Morde. Seit 18 Jahren im System. Keine disziplinarischen Eskalationen seit langer Zeit. Hohe verbale Intelligenz.",
  "funktion_im_buch": "Kein Daemon, kein Genie-Orakel. Gefaehrlich, weil er Aufmerksamkeit, Sprache und professionelle Routinen besser liest als die meisten Therapeuten.",
  "waffe": {
...
### Dr. Ina Rausch — „Die Klinikleitung"
```json
{
  "character_id": "RAUSCH",
  "name": "Dr. Ina Rausch",
  "role": "AErztliche Direktorin Hohenhort",
  "funktion": "Institutioneller Gegenspieler ohne Schurkenfunktion",
  "kern": "Will ein unangreifbares Verfahren. Ist weder fuer Cord noch gegen Fehr, sondern fuer Systemstabilitaet."
}
```

### Lea Fehr — „Die Tochter"
```json
{
  "character_id": "LEA",
  "name": "Lea Fehr",
...
### Judith Winter — „Die alte Schuld"
```json
{
  "character_id": "WINTER",
  "name": "Judith Winter",
  "role": "Schwester des spaeteren Opfers aus Fehrs altem Fehlfall",
  "funktion": "Verbindung zwischen alter Wunde und aktuellem Fall",
  "kern": "Sie will kein Rachetheater, sondern Wahrheit. Gerade deshalb ist sie fuer Fehr gefaehrlicher."
}
```
...
```json
{
  "open_threads": [
    {
      "id": "OT001",
      "thread": "Ist Cord tatsaechlich fuer unbegleitete Lockerungen geeignet oder nur perfekt systemkompatibel geworden?",
      "status": "offen",
      "payoff_act": "Act 3"
    },
    {
      "id": "OT002",
      "thread": "Woher kennt Cord Details aus Fehrs altem Fehlfall, die nicht oeffentlich sein sollten?",
      "status": "offen",
      "payoff_act": "Act 2/3"
    },
    {
      "id": "OT003",
      "thread": "Ist Fehr objektiver Gutachter oder benutzt er Cord, um seine eigene Vergangenheit zu korrigieren?",
      "status": "offen",
      "payoff_act": "Act 3"
    },
    {
      "id": "OT004",
      "thread": "Welche institutionellen Interessen verschieben das Verfahren im Hintergrund?",
      "status": "offen",
      "payoff_act": "Act 2"
    },
    {
      "id": "OT005",
      "thread": "Was ist in Fehrs altem Gutachten damals konkret uebersehen oder weggedrueckt worden?",
      "status": "offen",
      "payoff_act": "Act 2"
    }
  ]
...
### ACT 1 — „Der Auftrag"
> Eroeffnungs-Dokument: *Auszug aus gerichtlichem Anschreiben: „Es soll insbesondere Stellung genommen werden zur Frage, ob bei dem Untergebrachten weitere erhebliche rechtswidrige Taten zu erwarten sind, falls unbegleitete Vollzugslockerungen gewaehren werden."*
...
Scene Card
  id: SC_1_1
  pov: FEHR
  ort: Kanzlei / Auto / Klinikparkplatz
  uhrzeit: 07:40 Uhr
...
### ACT 2 — „Gegenuebertragung"
> Eroeffnungs-Dokument: *Interner Klinikvermerk: „Herr Cord zeigt im Stationsalltag hohe Regelbindung, konstante Mitarbeit und keine aggressiven Auffaelligkeiten."*
...
#### Kapitel 7: „Die Institution denkt mit"
```
Scene Card
  id: SC_2_4
  pov: FEHR
...
### ACT 3 — „Das Protokoll kippt"
> Eroeffnungs-Dokument: *Auszug aus Fehrs Entwurfsdatei: „Eine guenstige Legalprognose setzt nicht nur verbale Einsicht, sondern belastbare Transferfaehigkeit ausserhalb des geschuetzten Rahmens voraus."*
...
## STRUKTURABGLEICH FUER EMBER

### Was diese Regie bewusst anders macht als der erste Claude-Wurf
- Das Buch ist kein reines Zwei-Personen-Kammerspiel. Es hat eine Aussenwelt mit echtem Druck.
- Der forensische Auftrag ist konkretisiert: Legalprognose vor Lockerungsentscheidung, nicht vages „resozialisierbar?".
...
- Markt-Hook: vorhanden
- Writer Constitution: stabil
- Szenische Engine: vorhanden
- Scene Cards fuer alle Hauptkapitel: vorhanden
